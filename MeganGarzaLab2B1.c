...
functionRuntimes timeAlgorithm( char *name, int numTestCases, int numTestCaseSizes, int testCaseSizes[], void (*f)(FILE *) )
{
    ...
    fRT.avg = (double *) malloc(numTestCaseSizes * sizeof(double)); /* instead malloc an array of double*s of size numTestCaseSizes */;
	...
	//fRT.avg = (double*)malloc(sizeof(double));
	computeAvg(fRT);
